...
function operation(op) {
     ...
     */
    return function (collectionName, data1, data2,data3) {
        return new Promise((resolve, reject) => {
                ...
                switch (op) {
                    case 'insert': {
                        ...
                        if(!data2) {
                            ...
                            collection.insert(data1,data2, returnResult)
                        }
                    ...
                    case 'update': {
                        ...
                        //  data2 为修改参数
                       if(!data3) {
                           collection.updateMany(data1, data2, returnResult)

                        }else{
                           collection.update(data1, data2,data3, returnResult)
                       }
                        break;
                    }
                    case 'find': {
                        ...
                        collection.find(data1).toArray(returnResult);
                            ...
                            collection.find(data1,data2).toArray(returnResult);
                        }
                        break;
                    }
                    case 'remove': {
